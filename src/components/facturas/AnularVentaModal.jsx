...
export default function AnularVentaModal({ factura, motivo, setMotivo, msg, loading, onConfirm, onCancel }) {
  if (!factura) return null;

  return (
    <>
      <div
        style={{ position: "fixed", inset: 0, zIndex: 1060, background: "rgba(0,0,0,0.55)", backdropFilter: "blur(2px)" }}
          ...
          <div className="card-body p-4">
            <div className="text-center mb-3">
              ...
              <p className="text-muted small mb-0">
                Venta #{factura.id_factura} por <strong>{money(factura.total_neto)}</strong>
              </p>
