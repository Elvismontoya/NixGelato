...
export const actualizarProducto = (id, body) => apiPut(`/api/productos/${id}`, body)
export const eliminarProducto   = (id) => apiDelete(`/api/productos/${id}`)
export const getVentasProducto  = (id, params) => apiGet(`/api/productos/${id}/ventas${buildQuery(params)}`)
