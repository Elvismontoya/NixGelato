...
// Y-M-D en horario local (sin usar toISOString para evitar desfase de día)
const toYMD = (d) => {
  ...
  async function cargarAuditoria() {
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/auditoria`,
        {
          headers: { Authorization: `Bearer ${getToken()}` },
        }
      );
    ...
    <>
      ...
      <main className="container my-4">
        ...
        <section className="hero mb-4 text-center fade-in">
          <div className="hero-content">
            ...
            <p className="lead mb-4">
              La auditoría  revisión sistemática e independiente de un sistema o actividad para comprobar que cumple normas y procedimientos, verificar la información y detectar errores o áreas de mejora.
            </p>
          </div>
        </section>
          ...
          {ingresosHoy && (
            <div className="col-12 col-md-3">
              <StatCard
                ...
                sub={`${ingresosHoy.total_ventas} ventas · Prom: ${money(
                  ingresosHoy.promedio_venta
                )}`}
              />
            </div>
          )}
        ...
        <Section
          ...
          countLabel={`${ingresosDia.length} días`}
            ...
            <table className="table align-middle table-striped table-hover">
              ...
              <tbody className="stagger-children">
                {loadingIngresos ? (
                  ...
                  <EmptyRow
                    cols={4}
                    text="No hay datos de ingresos para el período seleccionado"
                  />
                ) : (
                  ingresosDia.map((it, i) => {
                    const fechaLocal = parseYMDToLocalDate(it.fecha);
                    return (
                      <tr key={i}>
                        <td>
                          <strong>
        ...
        <Section
          ...
          countLabel={`${auditoria.length} registros`}
          className="fade-in"
        >
          <div className="table-responsive" style={{ maxHeight: 520 }}>
            <table className="table align-middle table-striped table-hover">
              ...
              <tbody className="stagger-children">
                {loadingAuditoria ? (
                  ...
                  <EmptyRow cols={6} text="No hay registros de auditoría" />
                ) : (
                  auditoria.map((it) => (
                    <tr key={it.id_auditoria ?? it.id}>
                      <td className="small">
    ...
    <nav className="navbar navbar-expand-lg border-bottom sticky-top">
      <div className="container">
        ...
        <div className="d-flex flex-wrap gap-2">
          <Link className="btn btn-sm btn-outline-brand" to="/pedido">
            Caja / Pedido
          </Link>
          ...
          <div className="col-md-4 text-center text-md-end">
            <div className="d-flex justify-content-center justify-content-md-end gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-decoration-none text-muted hover-lift"
              >
                Instagram
              </a>
              <a
  ...
  return (
    <tr>
      <td colSpan={cols} className="text-center text-muted py-5">
        ...
        <small>
          Prueba ajustando el rango de fechas o pulsa “Aplicar filtros”.
        </small>
      </td>
    </tr>
  );
